...
async def logo(bot, message):
  try:
    ...
    x = await message.reply_text("`🔍 Generating Logo For You...❤️`")  
...
async def start_menu(_,query):
  await query.answer()
  await query.message.edit(START,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="Help", callback_data="help_menu"),InlineKeyboardButton(text="Repo", url="https://github.com/IMchathush")]]))
